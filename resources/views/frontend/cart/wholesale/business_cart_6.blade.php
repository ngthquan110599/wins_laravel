            ...
            <div class="menu_bought align_content">
                <div class="menu_bought_content font">
                   <ul>
                       ...
                       <li class="li_border2 nav-cart ">Chờ lấy hàng</li>
                       <li class="li_border2 nav-cart ">Đang giao</li>
                       <li class="li_border2 nav-cart active">Đã giao</li>
            ...
            <div class="cart padd" id="container-cart">
                <div class="cart_buy_together">
                    ...
                    <div class="cart_line_3">
                        <div class="amount_money_cover">
                            <div class="amount-money">
                                <span class="abc2 font">Tổng <span class="abc2 font">1</span> sản phẩm số tiền</span>
                    ...
                    <div class="options_line_4">
                        ...
                        <div class="options_order">
                            <button class="btn_add_vote_2">Đánh giá</button>
                            <button class="btn_abort_buy_ag_2">Đặt lại</button>
                            <button class="btn_view_pr_2">Xem chi tiết đơn hàng</button>                       
                        </div>
                    </div>
                ...
                <div class="cart_buy_together">
                    ...
                    <div class="options_line_4">
                        ...
                        <div class="options_order">
                            <button class="btn_add_vote_2" style="background: #666666;">Đã đánh giá</button>
                            <button class="btn_abort_buy_ag_2">Đặt lại</button>
                            <button class="btn_view_pr_2">Xem chi tiết đơn hàng</button>                       
                        </div>
                    </div>
